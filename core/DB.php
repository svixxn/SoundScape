...
class DB
{
    ...
    public function __construct($server, $login, $database)
    {
        $this->pdo = new \PDO("mysql:host={$server};dbname={$database};charset=UTF8", $login);
    }
    //CRUD
     ...
     */
    public function select($table, $fields = "*", $where, $orderBy = null, $limit=null, $offset=null)
    {
        $fieldsStr = "*";
        if (is_string($fields)) {
            $fieldsStr = $fields;
